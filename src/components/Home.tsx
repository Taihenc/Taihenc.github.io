...
export default function Home() {
  ...
  return (
    <>
      ...
      <section id="home" className="relative snap-center">
        <div className="flex justify-center items-start md:items-center">
          <div className="flex max-h-full max-w-full overflow-hidden items-start justify-center md:items-center">
            <div className="flex gap-6 justify-start md:justify-center items-center h-[100vh] w-[100vw] flex-col pt-14 pl-2 pr-2 md:flex-row md:pt-20 md:p-16">
              <div className="transition-all mockup-code max-h-[50rem] md:h-[70vh] max-w-[50rem] min-w-0 md:w-[40rem] bg-opacity-60 w-[90%] shrink-[1] flex flex-col self-center bg-base-100 md:self-start">
                <div className="transition-all w-fit overflow-y-auto">
                  <TypingEffect
                    ...
                    onCharTyped={keyboardRef.press}
                    textHighlight={[
                      {
                        word: 'Peerapat Pacharamontree',
                        className: 'text-red-200',
                      },
                      { word: 'Atom', className: 'text-red-200' },
                      { word: 'Taihen', className: 'text-yellow-300' },
                      {
                        word: 'Chulalongkorn University',
                  ...
                  {finished && (
                    <TypingEffect
                      text={['Initiate(BrowserWindow())']}
                      isTerminal
                      endRemoveCursor
                      onCharTypedEnd={() => setInitBrowser(true)}
                      onCharTyped={keyboardRef.press}
                    />
                  )}
                  {initBrowser && (
                    <TypingEffect
                      text={["Browser.loadURL('https://taihenc.github.io')"]}
                      isTerminal
                      onCharTypedEnd={() => setLoadURL(true)}
                      onCharTyped={keyboardRef.press}
                    />
                  )}
                </div>
              ...
              {initBrowser && (
                <div className="mockup-show mockup-browser h-60 min-h-[9rem] max-w-[80%] min-w-[1rem] w-[5rem] mb-28 bg-opacity-60 shrink-[2] border-none flex flex-col bg-base-100 md:self-start">
                  <div className="mockup-browser-toolbar">
                    <div className="input">
                      {loadURL && (
                        <TypingEffect
                          text={['https://github.com/Taihenc']}
                          isPlainText
                          onCharTyped={keyboardRef.press}
                        />
                      )}
                  ...
                  <div className="w-full h-full flex items-center justify-center">
                    {loadURL && (
                      <a
                        ...
                        className="github-show w-fit h-0 p-2 pt-3 pl-4 pr-4 flex justify-center items-center gap-2 bg-black text-white rounded-md text-lg opacity-70 hover:text-red-200"
                      >
                        <FontAwesomeIcon
                          icon={['fab', 'github']}
            ...
            <div className="md:block hidden w-[70%] max-w-xl aspect-[2/1] absolute bottom-5 md:right-4 md:bottom-8">
              ...
              >
                ...
                <Model
                  ...
                  rotation={[0, 1, 0]}
                  scale={[10, 10, 10]}
                  controller={keyboardRef}
                  keyboardGroupRefCallback={IdleAnimation}
                />
                <OrbitControls />
              </Canvas>
            </div>
            ...
            >
              <g className="arrows" transform="translate(7, 5)">
                <polyline
                  ...
                  points="34.7 64.95 40.73 58.79 40.75 58.8 46.91 64.83"
                />
                <polyline
                  className="arrow-up-2"
                  points="34.7 74.99 40.73 68.83 40.75 68.85 46.91 74.88"
                />
                <polyline
                  className="arrow-up-1"
                  points="34.7 85.04 40.73 78.88 40.75 78.89 46.91 84.92"
                />
              </g>
            </svg>
          </div>
