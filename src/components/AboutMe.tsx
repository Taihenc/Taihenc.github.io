      ...
      <div id="about-me" className="w-full h-full bg-[#1a252f] bg-opacity-75">
        <div className="w-full h-full backdrop-blur-sm flex justify-center items-center overflow-hidden">
          <div className="w-full h-full md:p-28 p-6 flex justify-center items-center">
            <div className="w-full h-full max-w-[100rem] max-h-[50rem] relative rounded-xl bg-opacity-[80%] bg-base-200">
              ...
              <div className="w-full h-full p-3 md:p-6 md:py-[5%] md:px-[7%] flex justify-center items-center">
                <div className="w-full h-full flex flex-col lg:flex-row justify-center items-center">
                  <div className="max-h-full w-[20rem] md:mt-16 flex flex-col shrink justify-center items-center order-2">
                    <div className="stack max-w-[18rem] md:w-3/4 w-[40%] relative shrink-[2] rounded-lg shadow-2xl">
                    ...
                    <div className="w-fit mt-2 md:mt-16 flex flex-col">
                      <p className="md:w-max text-sm md:text-base text-center font-serif">"If you gaze f or long into an abyss, nothing happens."</p>
                      <p className="pt-2 md:pt-5 text-center text-xs md:text-sm text-yellow-300">Peerapat Patcharamontree</p>
                    </div>
                  </div>
                  <div className="w-full max-w-[55rem] p-5 lg:pr-[7rem] md:pb-16 flex flex-col max-h-full shrink overflow-hidden order-1">
                    <h1 className="w-full mb-5 text-4xl md:text-5xl font-bold text-red-200">Greeting!! 👋 I'm Atom</h1>
                    <h1 className="text-lg md:text-2xl md:pt-6 font-bold">About me</h1>
                    <p className="max-h-[10rem] py-2 indent-6 overflow-auto shrink">
