...
export function KeyboardEvent(character: string) {
    /*
...
*/
    ...
    let addKey = (character: string) => {
        let kc = (character == '13') ? 13 : character.toUpperCase().charCodeAt(0);
        if (kc == 13) { console.log("enter"); kd[39].classList.add("key--down"); }
        ...
        if ((kc >= 65 && kc <= 90) || kc == 32) {
            ...
            else if (kc == 13) { kd[39].classList.add("key--down"); console.log("enter"); }
            else if (kc == 32) {
